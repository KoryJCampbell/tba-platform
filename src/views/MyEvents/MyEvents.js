  ...
  render() {
    return (
      ...
      <Row>
        ...
        <Card>
            <CardHeader>
              <i className="fa fa-align-justify"></i><strong>Current Events</strong>
              {/* <small> tags</small> */}
            </CardHeader>
            <CardBody>
              <ListGroup>
          ...
          <Card>
            <CardHeader>
              <i className="fa fa-align-justify"></i><strong>Event Drafts</strong>
              {/* <small> tags</small> */}
            </CardHeader>
            <CardBody>
              <ListGroup>
          ...
          <Card>
            <CardHeader>
              <i className="fa fa-align-justify"></i><strong>Past Events</strong>
              {/* <small> tags</small> */}
            </CardHeader>
            <CardBody>
              <ListGroup>
